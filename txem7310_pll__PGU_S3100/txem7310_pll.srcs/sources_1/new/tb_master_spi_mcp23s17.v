`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Module Name: tb_master_spi_mcp23s17
// 
//----------------------------------------------------------------------------
...
//
//
// test  master_spi_mcp23s17.v
//
//////////////////////////////////////////////////////////////////////////////////


module tb_master_spi_mcp23s17;
...
master_spi_mcp23s17 #(
	...
	//
	.i_CS_id            (1'b1), //       
	.i_pin_adrs_A       (3'b0), // [2:0] 
	.i_R_W_bar          (test_frame_rdwr), //       
	.i_reg_adrs_A       (8'h12), // [7:0] 
	.i_wr_DA            (8'h00), // [7:0] 
	.i_wr_DB            (8'h08), // [7:0] 
	.o_rd_DA            (), // [7:0] 
	.o_rd_DB            (), // [7:0] 
