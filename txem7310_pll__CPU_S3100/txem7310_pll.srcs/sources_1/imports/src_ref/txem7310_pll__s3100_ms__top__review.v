...
parameter FPGA_IMAGE_ID = 32'hA0_21_0708; // S3100-CPU-BASE // merge git
...
wire [15:0] w_FAN_SPEED0 = 16'h1111;        // TEST VAL     w_FAN_SPEED0;
wire [15:0] w_FAN_SPEED1 = 16'h2222;
wire [15:0] w_FAN_SPEED2 = 16'h3333;
wire [15:0] w_FAN_SPEED3 = 16'h4444;

wire [15:0] w_FAN_SPEED4 = 16'h5555;
wire [15:0] w_FAN_SPEED5 = 16'h6666;
wire [15:0] w_FAN_SPEED6 = 16'h7777;
wire [15:0] w_FAN_SPEED7 = 16'h8888;
...
reg  [7:0]  r_GPIB_CTRL;
reg   [31:0] r_DATA_BUS;
wire  [31:0] w_DATA_BUS_h0006;
wire  [31:0] w_DATA_BUS_h0009;
wire  [31:0] w_DATA_BUS_h000E;

wire  [31:0] w_DATA_BUS_h0010;
wire  [31:0] w_DATA_BUS_h0011;
wire  [31:0] w_DATA_BUS_h0012;
wire  [31:0] w_DATA_BUS_h0013;

wire  [31:0] w_DATA_BUS_h0014;
wire  [31:0] w_DATA_BUS_h0015;
wire  [31:0] w_DATA_BUS_h0016;
wire  [31:0] w_DATA_BUS_h0017;

wire  [31:0] w_DATA_BUS_h0300;
wire  [31:0] w_DATA_BUS_h0301;
wire  [31:0] w_DATA_BUS_h0302;
...
wire w_match_adrs_cs_MAGIC_CODE = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_0000)? 1'b1 : 1'b0 ;      // 0x6010_0000    0x33AA_CC55 (MAGIC CODE)
wire w_match_adrs_cs_FPGA_IMAGE = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_0001)? 1'b1 : 1'b0 ;      // 0x6010_0004    0xA021_0708 (FPGA_IMAGE_ID)
wire w_match_adrs_cs__BUS_h0006 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_0110)? 1'b1 : 1'b0 ;      // 0x6010_0018    0x0000_000x (INTER_LOCK_ON)
wire w_match_adrs_cs__BUS_h0009 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_1001)? 1'b1 : 1'b0 ;      // 0x6010_0024    0x0000_0x0x (MASTER) (LAN_IP)
wire w_match_adrs_cs__BUS_h000E = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_1110)? 1'b1 : 1'b0 ;      // 0x6010_0038    0x0000_000x (H I/F IN)
wire w_match_adrs_cs__BUS_h0010 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0000)? 1'b1 : 1'b0 ;      // 0x6010_0040    0x0000_xxxx (FAN_SPEED0)
wire w_match_adrs_cs__BUS_h0011 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0001)? 1'b1 : 1'b0 ;      
wire w_match_adrs_cs__BUS_h0012 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0010)? 1'b1 : 1'b0 ;
wire w_match_adrs_cs__BUS_h0013 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0011)? 1'b1 : 1'b0 ;
wire w_match_adrs_cs__BUS_h0014 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0100)? 1'b1 : 1'b0 ;
wire w_match_adrs_cs__BUS_h0015 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0101)? 1'b1 : 1'b0 ;
wire w_match_adrs_cs__BUS_h0016 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0110)? 1'b1 : 1'b0 ;
wire w_match_adrs_cs__BUS_h0017 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b01_0111)? 1'b1 : 1'b0 ;
                                                                   
wire w_match_adrs_cs__BUS_h0300 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_0000)? 1'b1 : 1'b0 ;
wire w_match_adrs_cs__BUS_h0301 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_0001)? 1'b1 : 1'b0 ;
wire w_match_adrs_cs__BUS_h0302 = (w_nBNE1 == 1'b0 && w_nCS_REG_sig && r_ADRS_BUS [5:0] == 6'b00_0010)? 1'b1 : 1'b0 ;
...
always @(posedge host_clk, negedge reset_n) begin
    if (!reset_n) begin
        ...
        r_DATA_BUS <= (w_match_adrs_cs_MAGIC_CODE && w_OE_BUS == 1'b0) ? w_M0_port_wo_sadrs_h380 :        // 0x6010_0000    0x33AA_CC55 (MAGIC CODE)
                      (w_match_adrs_cs_FPGA_IMAGE && w_OE_BUS == 1'b0) ? w_F_IMAGE_ID_WO :                // 0x6010_0004    0xA021_0708 (FPGA_IMAGE_ID)
                      (w_match_adrs_cs__BUS_h0006 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0006 :               // 0x6010_0018    0x0000_000x (INTER_LOCK_ON)
                      (w_match_adrs_cs__BUS_h0009 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0009 :               // 0x6010_0024    0x0000_0x0x (MASTER) (LAN_IP)
                      (w_match_adrs_cs__BUS_h000E && w_OE_BUS == 1'b0) ? w_DATA_BUS_h000E :               // 0x6010_0038    0x0000_000x (H I/F IN)
                      (w_match_adrs_cs__BUS_h0010 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0010 :               // 0x6010_0040    0x0000_xxxx (FAN_SPEED0)
                      (w_match_adrs_cs__BUS_h0011 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0011 :               // 0x6010_0044    0x0000_xxxx (FAN_SPEED1)
                      (w_match_adrs_cs__BUS_h0012 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0012 :               // 0x6010_0048    0x0000_xxxx (FAN_SPEED2)
                      (w_match_adrs_cs__BUS_h0013 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0013 :               // 0x6010_004C    0x0000_xxxx (FAN_SPEED3)
                      (w_match_adrs_cs__BUS_h0014 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0014 :               // 0x6010_0050    0x0000_xxxx (FAN_SPEED4)
                      (w_match_adrs_cs__BUS_h0015 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0015 :               // 0x6010_0054    0x0000_xxxx (FAN_SPEED5)
                      (w_match_adrs_cs__BUS_h0016 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0016 :               // 0x6010_0058    0x0000_xxxx (FAN_SPEED6)
                      (w_match_adrs_cs__BUS_h0017 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0017 :               // 0x6010_005C    0x0000_xxxx (FAN_SPEED7)
                      
                      (w_match_adrs_cs__BUS_h0300 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0300 :               // 0x6030_0000    0x0000_xxxx (GPIB_STATUS)
                      (w_match_adrs_cs__BUS_h0301 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0301 :               // 0x6030_0004    0x0000_xxxx (GPIB_CONTROL)
                      (w_match_adrs_cs__BUS_h0302 && w_OE_BUS == 1'b0) ? w_DATA_BUS_h0302 :               // 0x6030_0008    0x0000_xxxx (GPIB_SW)
                      r_DATA_BUS;
    end
end

assign w_BD_out = r_DATA_BUS;

// T = '1' ==> 'Z' (INPUT)    // T = '0' ==> OUTPUT
assign w_BD_tri = ((w_match_adrs_cs_MAGIC_CODE | 
                    w_match_adrs_cs_FPGA_IMAGE |
                    ...
                    w_match_adrs_cs__BUS_h0302 ) & !r_smp_OE_BUS[0]) ? 32'h0000_0000 : 32'hFFFF_FFFF;           //!r_smp_OE_BUS[1]
...
always @(posedge host_clk, negedge reset_n) begin          // ------- to FPGA Write -----------//
    if (!reset_n) begin
        r_ERR_LED       <= 1'b1;        // Low Active
        r_test_led      <= 4'b1111;     // Low Active
        r_INTER_L_LED   <= 1'b1;        // Low Active
        r_INTER_L_RLY   <= 1'b0;       
        r_SW_RESET      <= 1'b1;        // Low Active
        r_H_OUT         <= 4'b0000;      
        ...
        r_test_led      <= ( w_rise_WE_BUS && w_nCS_REG_sig  && (r_ADRS_BUS[5:0] == 6'b00_0100)) ? w_BD_in[3:0]   : r_test_led;           // FPGALED         0x6010 0010 
        ...
        r_SW_RESET      <= ( w_rise_WE_BUS && w_nCS_REG_sig  && (r_ADRS_BUS[5:0] == 6'b00_1010)) ? w_BD_in[0]     : r_SW_RESET;           // SW_RESET        0x6010 0028
...
wire [13:0] w_ADRS_active = ( w_CS_BUS && (r_ADRS_BUS[5:0] == 6'b000000) ) ? 1'b1 : 
                             (w_CS_BUS  && (r_ADRS_BUS[5:0] == 6'b000001) ) ? 1'b1 :
                             1'b0;
wire w_tri_BUS = ( (w_ADRS_active) && (~r_smp_OE_BUS[0]) )? 1'b0 : 1'b1; // out en


assign _tri = w_CS_BUS; 
...
led_test  led_test__inst (
	...
	.o_run_led_fast(FPGA_LED_RUN_STATUS_FAST),
	.valid         (                   )
	);	
...
assign test_point[0] = w_BD_out[0];
assign test_point[1] = w_rise_WE_BUS; 
assign test_point[2] = w_OE_BUS;
assign test_point[3] = !r_smp_OE_BUS[0]; 

assign test_point[4] = w_BD_tri[0]; 
assign test_point[5] = w_BD_tri[1]; 
assign test_point[6] = w_match_adrs_cs__BUS_h0009;  
assign test_point[7] = w_nCS_REG_sig; 
