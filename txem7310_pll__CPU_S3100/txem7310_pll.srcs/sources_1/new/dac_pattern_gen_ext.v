...
// common para for dsp 
parameter STATE_SIG_0 = 3'h00; // initial 
	// clear cnt_idx_dac0
parameter STATE_SIG_1 = 3'h01; // pulse start; data from fifo 
	// count up cnt_idx_dac0 // until reach to r_cid_reg_dac0_num_ffdat
parameter STATE_SIG_2 = 3'h02; // pulse repeat
	// count up cnt_rpt_dac0
parameter STATE_SIG_3 = 3'h03;  // unused
parameter STATE_SIG_4 = 3'h04;  // unused
parameter STATE_SIG_5 = 3'h05;  // unused
parameter STATE_SIG_6 = 3'h06;  // unused
parameter STATE_SIG_7 = 3'h07;  // unused
...
// fifo data load 
assign w_fcid_data_load_dac0     = ((r_state_dsp48__dac0 == STATE_SIG_1) && (w_cnt_dur_dac0 == 0))? 1'b1 : 1'b0;
...
reg_rep__dsp48_macro_APC_b32_0  dsp48__AP_C__r_fcid_cnt_idx_dac0__inst (
	.CLK   (i_clk_dac0_dco            ),  // input wire CLK   // negative edge
...
assign w_CE___dsp48_cnt_idx_dac0 = ((r_state_dsp48__dac0 == STATE_SIG_1) && (w_cnt_dur_dac0 == 0))? 1'b1 : 1'b0;
assign w_SCLR_dsp48_cnt_idx_dac0 = (r_state_dsp48__dac0 == STATE_SIG_0)? 1'b1 : 
...
assign      w_CE___dsp48_cnt_rpt_dac0 = (r_state_dsp48__dac0 == STATE_SIG_2)? 1'b1 : 1'b0;
assign      w_SCLR_dsp48_cnt_rpt_dac0 = (r_state_dsp48__dac0 == STATE_SIG_0)? 1'b1 : 1'b0;
...
// update state for dac0 
always @(posedge i_clk_dac0_dco, negedge i_rstn_dac0_dco) begin 
	if (!i_rstn_dac0_dco) begin 
		r_state_dsp48__dac0 <= STATE_SIG_0;
	end
	...
	STATE_SIG_1 : begin
		if ((w_cnt_idx_dac0 >= r_cid_reg_dac0_num_ffdat - 1) && (w_cnt_dur_dac0 == 0)) begin
			r_state_dsp48__dac0 <= STATE_SIG_2;
			end
		else if (w_hold_pulse_dac0) begin // pulse stop by user command
			r_state_dsp48__dac0 <= STATE_SIG_0;
			end
		end
...
// fifo data load 
assign w_fcid_data_load_dac1     = ((r_state_dsp48__dac1 == STATE_SIG_1) && (w_cnt_dur_dac1 == 0))? 1'b1 : 1'b0;
...
reg_rep__dsp48_macro_APC_b32_0  dsp48__AP_C__r_fcid_cnt_idx_dac1__inst (
	.CLK   (i_clk_dac1_dco            ),  // input wire CLK   // negative edge
...
assign w_CE___dsp48_cnt_idx_dac1 = ((r_state_dsp48__dac1 == STATE_SIG_1) && (w_cnt_dur_dac1 == 0))? 1'b1 : 1'b0;
assign w_SCLR_dsp48_cnt_idx_dac1 = (r_state_dsp48__dac1 == STATE_SIG_0)? 1'b1 : 
...
assign      w_CE___dsp48_cnt_rpt_dac1 = (r_state_dsp48__dac1 == STATE_SIG_2)? 1'b1 : 1'b0;
assign      w_SCLR_dsp48_cnt_rpt_dac1 = (r_state_dsp48__dac1 == STATE_SIG_0)? 1'b1 : 1'b0;
...
// update state for dac1 
always @(posedge i_clk_dac1_dco, negedge i_rstn_dac1_dco) begin 
	if (!i_rstn_dac1_dco) begin 
		r_state_dsp48__dac1 <= STATE_SIG_0;
	end
	...
	STATE_SIG_1 : begin
		if ((w_cnt_idx_dac1 >= r_cid_reg_dac1_num_ffdat - 1) && (w_cnt_dur_dac1 == 0)) begin
			r_state_dsp48__dac1 <= STATE_SIG_2;
			end
		else if (w_hold_pulse_dac1) begin // pulse stop by user command
			r_state_dsp48__dac1 <= STATE_SIG_0;
			end
		end
...
// r_fcid_dat_out_dac0 --> w_dat_out_dac0 // for dsp
// r_fcid_dat_out_dac1 --> w_dat_out_dac1 // for dsp
assign o_dac0_data_pin = (flag_cid_ff_pulse_run_dac0[0])? w_dat_out_dac0
						:(flag_cid_sq_pulse_run_dac0[0])? r_cid_dat_out_dac0
						: 16'b0;
						
assign o_dac1_data_pin = (flag_cid_ff_pulse_run_dac1[0])? w_dat_out_dac1
