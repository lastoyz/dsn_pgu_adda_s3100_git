...
//--------------------------------------------------------------------------------
//Command: generate_target bd_3c9d.bd
//Design : bd_3c9d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_3c9d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_3c9d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "microblaze_mcs_1.hwdef" *) 
module bd_3c9d
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    IO_write_strobe,
    Reset);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_3c9d_Clk, FREQ_HZ 72000000, PHASE 0.000" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > bd_3c9d lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_3c9d_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_3c9d_ilmb_cntlr_0 ilmb_cntlr
       (.BRAM_Addr_A(ilmb_port_ADDR),
        ...
        .Sl_UE(ilmb_sl_0_UE),
        .Sl_Wait(ilmb_sl_0_WAIT));
  bd_3c9d_iomodule_0_0 iomodule_0
       (.Clk(Clk3),
  ...
  bd_3c9d_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_3c9d dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_3c9d_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk3),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_3c9d_xlconcat_0_0 xlconcat_0
       (.In0(Dbg_Wakeup),
        .In1(Dbg_Wakeup),
        .dout(Wakeup));
endmodule
