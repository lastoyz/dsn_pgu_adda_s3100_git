...
namespace TopInstrument{
    ...
    {
        //
        void hvpgu_init(u32 slot, u32 spi_sel);
        void hvpgu_standby(u32 slot, u32 spi_sel);
        void hvpgu_ready__40V(u32 slot, u32 spi_sel);
        void hvpgu_read_inp__printout(u32 slot, u32 spi_sel);
        //
    }
    ...
    public partial class __PGU 
    {
        ...
        public enum __enum_EPA 
        {
            ...
            EP_ADRS__HVPGU_TEST_LED_WI  = 0x01, //$$ HVPGU // 0x004
            EP_ADRS__HVPGU_TEST_LED_TI  = 0x41, //$$ HVPGU // 0x104
    ...
    public partial class PGU : I_slot 
    {
        // slot functions
    ...
    public partial class PGU : I_dev_common
    {
        //
    ...
    public partial class PGU : I_HVPGU 
    {
        //
        ...
        //
        public void hvpgu_init(u32 slot, u32 spi_sel) 
        {
            hvpgu_standby(slot, spi_sel);
            hvpgu_reset_latch(slot, spi_sel);
        }
        public void hvpgu_standby(u32 slot, u32 spi_sel) 
        {
            ...
            hvpgu_set_outp(slot, spi_sel); // final update
        }
        public void hvpgu_ready__40V(u32 slot, u32 spi_sel) 
        {
        ...
        public void hvpgu_read_inp__printout(u32 slot, u32 spi_sel) 
        {
            hvpgu_get_inp(slot, spi_sel); // update
        ...
        //
        private void hvpgu_reset_latch(u32 slot, u32 spi_sel) {
            hvpgu_set_outp__LATCH_RST2 (0);
            hvpgu_set_outp__LATCH_RST1 (0);
            hvpgu_set_outp(slot, spi_sel); // final update
        ...
        //
        private void hvpgu_set_outp(u32 slot, u32 spi_sel) {
            ...
            SetWireInValue(slot, spi_sel, 
                (u32)__enum_EPA.EP_ADRS__HVPGU_WI, val);
        }
        private u32 hvpgu_get_inp(u32 slot, u32 spi_sel) {
            ...
            u32 ret = GetWireOutValue(slot, spi_sel, 
                (u32)__enum_EPA.EP_ADRS__HVPGU_WO);
            // update field
    ...
    public partial class PGU : I_ADDA
    {
        //// adda functions :
    ...
    public partial class PGU : I_spio
    {
        //
    ...
    public partial class PGU : I_dac 
    {
        //
    ...
    public partial class PGU : I_clkd 
    {
        //
    ...
    public partial class PGU : I_adc 
    {
        //
    ...
    public partial class PGU : I_dft 
    {
    ...
    public partial class PGU : I_printf 
    {
