...
namespace __test__
{
    ...
    static class Program
    {
        ...
        //public static string test_host_ip = "192.168.100.51"; // 
        public static string test_host_ip = "192.168.100.53"; // 
        ...
        public static uint test_loc_slot__ADDA  = 0x0000; // spi dummy outside  // for self LAN port test
        ...
        public static uint test_loc_slot__HVPGU = 0x0000; // spi dummy outside  // for self LAN port test
